...
import (
	"github.com/NordSecurity/gokogiri/html"
...
found in the github.com/NordSecurity/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
